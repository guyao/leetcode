        ...
        def build_s(r, index):
            ...
            if index < len(lst):
                ...
                for _ in range(index - (len(lst) - 1)):
                    lst.append(None)
            lst[index] = val
            build_s(r.left, 2*index + 1)
            build_s(r.right, 2*index + 2)
        build_s(root, 0)
    ...
    def deserialize(self, data):
        ...
        def build_tree(index):
            ...
            if val is not None:
                ...
                parent.left = build_tree(2*index + 1)
                parent.right = build_tree(2*index + 2)
            else:
                return
            return parent
        r = build_tree(0)
